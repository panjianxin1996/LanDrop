  ...
  return (
    <Tabs defaultValue="imgToBase64" onValueChange={handleTabChange}>
      ...
      <TabsContent value="imgToBase64" asChild>
        <div className="py-8 bg-gradient-to-br from-gray-50 to-gray-100 flex flex-col items-center justify-center p-4">
          <div className="w-full max-w-md bg-white rounded-xl shadow-lg p-6 space-y-6">
            <h1 className="text-2xl font-bold text-center text-gray-800">图片转 Base64</h1>
            {/* 文件上传 */}
            <div className="flex flex-col items-center justify-center border-2 border-dashed border-zinc-400 rounded-lg hover:bg-indigo-50 transition-colors">
              <input
                type="file"
                accept="image/*"
              ...
              <label
                htmlFor="file-upload"
                className="w-full  p-6 cursor-pointer flex flex-col items-center text-violet-950 font-medium"
              >
                <CloudUpload size={30} />
                选择图片
              </label>
